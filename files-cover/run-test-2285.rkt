#lang racket
; language question: racket, racket/base, typed/racket/base
; use typed/racket if there are any typed modules

;; require everything we could possible need here
(require
  "../base/untyped.rkt"
...
; deleted testing submodule

;; ====================================================
;; main.rkt

; deleted base/untyped require because it's already been required
; deleted zombie require
...
;(define DATA
;  (with-input-from-file "C:/Users/choco/OneDrive/Desktop/Projects-working/Coding-working/Dimoulas/Amy Working/cover/zombie-coverage-test/base/zombie-hist.rktd" read))
